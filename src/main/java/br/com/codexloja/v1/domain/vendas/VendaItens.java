package br.com.codexloja.v1.domain.vendas;

import br.com.codexloja.v1.domain.dto.VendaItensDto;
...
public class VendaItens implements Serializable {
    ...
    public VendaItens(Integer id, String cpf, String codigoProduto, String descricaoProduto, Integer quantidade, BigDecimal valorProduto, BigDecimal valorTotal) {
        this.id = id;
        this.cpf = cpf;

...
import br.com.codexloja.v1.domain.repository.NotaFiscalRepository;
    ...
    public List<NotaFiscalItens> obterItensXmlCompleto(NotasFiscais notasFiscais) {
        ...
        nfeIten.getNFe().getInfNFe().getDet().forEach(i -> {
            ...
            if (i.getProd().getRastro() != null && i.getProd().getRastro().size() > 0) {
                ...
                item.setNumeroLote(i.getProd().getRastro().get(0).getNLote() != null ?
                        i.getProd().getRastro().get(0).getNLote() : "");

package br.com.codex.v1.apinfe.cte300.webservices.recepcaoOS;
...
public class CteRecepcaoOSStub extends org.apache.axis2.client.Stub {
    ...
    public br.com.codex.v1.apinfe.cte300.webservices.recepcaoOS.CteRecepcaoOSStub.CteRecepcaoOSResult cteRecepcaoOS(final br.com.codex.v1.apinfe.cte300.webservices.recepcaoOS.CteRecepcaoOSStub.CteDadosMsg cteDadosMsg0, final br.com.codex.v1.apinfe.cte300.webservices.recepcaoOS.CteRecepcaoOSStub.CteCabecMsgE cteCabecMsg1) throws java.rmi.RemoteException {
        ...
        try {
            ...
            final java.lang.Object object = this.fromOM(_returnEnv.getBody().getFirstElement(), br.com.codex.v1.apinfe.cte300.webservices.recepcaoOS.CteRecepcaoOSStub.CteRecepcaoOSResult.class, this.getEnvelopeNamespaces(_returnEnv));
            return (br.com.codex.v1.apinfe.cte300.webservices.recepcaoOS.CteRecepcaoOSStub.CteRecepcaoOSResult) object;
     ...
     * @param cteCabecMsg1
     */
    public void startcteRecepcaoOS(final br.com.codex.v1.apinfe.cte300.webservices.recepcaoOS.CteRecepcaoOSStub.CteDadosMsg cteDadosMsg0, final br.com.codex.v1.apinfe.cte300.webservices.recepcaoOS.CteRecepcaoOSStub.CteCabecMsgE cteCabecMsg1, final br.com.codex.v1.apinfe.cte300.webservices.recepcaoOS.CteRecepcaoOSCallbackHandler callback) throws java.rmi.RemoteException {
        final org.apache.axis2.client.OperationClient _operationClient = this._serviceClient.createClient(this._operations[0].getName());
        _operationClient.getOptions().setAction("http://www.portalfiscal.inf.br/cte/wsdl/CteRecepcaoOS/cteRecepcaoOS");
        _operationClient.getOptions().setExceptionToBeThrownOnSOAPFault(true);
        this.addPropertyToOperationClient(_operationClient, org.apache.axis2.description.WSDL2Constants.ATTR_WHTTP_QUERY_PARAMETER_SEPARATOR, "&");
        ...
        _operationClient.setCallback(new org.apache.axis2.client.async.AxisCallback() {
            ...
            public void onMessage(final org.apache.axis2.context.MessageContext resultContext) {
                try {
                    ...
                    final java.lang.Object object = CteRecepcaoOSStub.this.fromOM(resultEnv.getBody().getFirstElement(), br.com.codex.v1.apinfe.cte300.webservices.recepcaoOS.CteRecepcaoOSStub.CteRecepcaoOSResult.class, CteRecepcaoOSStub.this.getEnvelopeNamespaces(resultEnv));
                    callback.receiveResultcteRecepcaoOS((br.com.codex.v1.apinfe.cte300.webservices.recepcaoOS.CteRecepcaoOSStub.CteRecepcaoOSResult) object);
    ...
    private org.apache.axiom.om.OMElement toOM(final br.com.codex.v1.apinfe.cte300.webservices.recepcaoOS.CteRecepcaoOSStub.CteDadosMsg param, final boolean optimizeContent) {
        //try {
        return param.getOMElement(br.com.codex.v1.apinfe.cte300.webservices.recepcaoOS.CteRecepcaoOSStub.CteDadosMsg.MY_QNAME, org.apache.axiom.om.OMAbstractFactory.getOMFactory());
        //        } catch (final org.apache.axis2.databinding.ADBException e) {
        //            throw org.apache.axis2.AxisFault.makeFault(e);
        //        }
    }

    private org.apache.axiom.om.OMElement toOM(final br.com.codex.v1.apinfe.cte300.webservices.recepcaoOS.CteRecepcaoOSStub.CteRecepcaoOSResult param, final boolean optimizeContent) {
        //try {
        return param.getOMElement(br.com.codex.v1.apinfe.cte300.webservices.recepcaoOS.CteRecepcaoOSStub.CteRecepcaoOSResult.MY_QNAME, org.apache.axiom.om.OMAbstractFactory.getOMFactory());
        //        } catch (final org.apache.axis2.databinding.ADBException e) {
        //            throw org.apache.axis2.AxisFault.makeFault(e);
        //        }
    }

    private org.apache.axiom.om.OMElement toOM(final br.com.codex.v1.apinfe.cte300.webservices.recepcaoOS.CteRecepcaoOSStub.CteCabecMsgE param, final boolean optimizeContent) {
        //try {
        return param.getOMElement(br.com.codex.v1.apinfe.cte300.webservices.recepcaoOS.CteRecepcaoOSStub.CteCabecMsgE.MY_QNAME, org.apache.axiom.om.OMAbstractFactory.getOMFactory());
        //        } catch (final org.apache.axis2.databinding.ADBException e) {
        //            throw org.apache.axis2.AxisFault.makeFault(e);
        //        }
    }

    private org.apache.axiom.soap.SOAPEnvelope toEnvelope(final org.apache.axiom.soap.SOAPFactory factory, final br.com.codex.v1.apinfe.cte300.webservices.recepcaoOS.CteRecepcaoOSStub.CteDadosMsg param, final boolean optimizeContent, final javax.xml.namespace.QName methodQName) {
        //try {
        final org.apache.axiom.soap.SOAPEnvelope emptyEnvelope = factory.getDefaultEnvelope();
        emptyEnvelope.getBody().addChild(param.getOMElement(br.com.codex.v1.apinfe.cte300.webservices.recepcaoOS.CteRecepcaoOSStub.CteDadosMsg.MY_QNAME, factory));
    ...
    private java.lang.Object fromOM(final org.apache.axiom.om.OMElement param, final java.lang.Class type, final java.util.Map extraNamespaces) throws org.apache.axis2.AxisFault {
        try {
            if (br.com.codex.v1.apinfe.cte300.webservices.recepcaoOS.CteRecepcaoOSStub.CteDadosMsg.class.equals(type)) {
                return br.com.codex.v1.apinfe.cte300.webservices.recepcaoOS.CteRecepcaoOSStub.CteDadosMsg.Factory.parse(param.getXMLStreamReaderWithoutCaching());
            }
            if (br.com.codex.v1.apinfe.cte300.webservices.recepcaoOS.CteRecepcaoOSStub.CteRecepcaoOSResult.class.equals(type)) {
                return br.com.codex.v1.apinfe.cte300.webservices.recepcaoOS.CteRecepcaoOSStub.CteRecepcaoOSResult.Factory.parse(param.getXMLStreamReaderWithoutCaching());
            }
            if (br.com.codex.v1.apinfe.cte300.webservices.recepcaoOS.CteRecepcaoOSStub.CteCabecMsgE.class.equals(type)) {
                return br.com.codex.v1.apinfe.cte300.webservices.recepcaoOS.CteRecepcaoOSStub.CteCabecMsgE.Factory.parse(param.getXMLStreamReaderWithoutCaching());
            }

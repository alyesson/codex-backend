package br.com.codex.v1.apinfe.cte300.webservices.recepcao;
...
public class CteRecepcaoStub extends org.apache.axis2.client.Stub {
    ...
    public br.com.codex.v1.apinfe.cte300.webservices.recepcao.CteRecepcaoStub.CteRecepcaoLoteResult cteRecepcaoLote(final br.com.codex.v1.apinfe.cte300.webservices.recepcao.CteRecepcaoStub.CteDadosMsg cteDadosMsg0, final br.com.codex.v1.apinfe.cte300.webservices.recepcao.CteRecepcaoStub.CteCabecMsgE cteCabecMsg1) throws java.rmi.RemoteException {
        ...
        try {
            ...
            final java.lang.Object object = this.fromOM(_returnEnv.getBody().getFirstElement(), br.com.codex.v1.apinfe.cte300.webservices.recepcao.CteRecepcaoStub.CteRecepcaoLoteResult.class, this.getEnvelopeNamespaces(_returnEnv));
            return (br.com.codex.v1.apinfe.cte300.webservices.recepcao.CteRecepcaoStub.CteRecepcaoLoteResult) object;
     ...
     * @param cteCabecMsg1
     */
    public void startcteRecepcaoLote(final br.com.codex.v1.apinfe.cte300.webservices.recepcao.CteRecepcaoStub.CteDadosMsg cteDadosMsg0, final br.com.codex.v1.apinfe.cte300.webservices.recepcao.CteRecepcaoStub.CteCabecMsgE cteCabecMsg1, final br.com.codex.v1.apinfe.cte300.webservices.recepcao.CteRecepcaoCallbackHandler callback) throws java.rmi.RemoteException {
        final org.apache.axis2.client.OperationClient _operationClient = this._serviceClient.createClient(this._operations[0].getName());
        _operationClient.getOptions().setAction("http://www.portalfiscal.inf.br/cte/wsdl/CteRecepcao/cteRecepcaoLote");
        _operationClient.getOptions().setExceptionToBeThrownOnSOAPFault(true);
        this.addPropertyToOperationClient(_operationClient, org.apache.axis2.description.WSDL2Constants.ATTR_WHTTP_QUERY_PARAMETER_SEPARATOR, "&");
        ...
        _operationClient.setCallback(new org.apache.axis2.client.async.AxisCallback() {
            ...
            public void onMessage(final org.apache.axis2.context.MessageContext resultContext) {
                try {
                    ...
                    final java.lang.Object object = CteRecepcaoStub.this.fromOM(resultEnv.getBody().getFirstElement(), br.com.codex.v1.apinfe.cte300.webservices.recepcao.CteRecepcaoStub.CteRecepcaoLoteResult.class, CteRecepcaoStub.this.getEnvelopeNamespaces(resultEnv));
                    callback.receiveResultcteRecepcaoLote((br.com.codex.v1.apinfe.cte300.webservices.recepcao.CteRecepcaoStub.CteRecepcaoLoteResult) object);
    ...
    private org.apache.axiom.om.OMElement toOM(final br.com.codex.v1.apinfe.cte300.webservices.recepcao.CteRecepcaoStub.CteDadosMsg param, final boolean optimizeContent) {
        //try {
        return param.getOMElement(br.com.codex.v1.apinfe.cte300.webservices.recepcao.CteRecepcaoStub.CteDadosMsg.MY_QNAME, org.apache.axiom.om.OMAbstractFactory.getOMFactory());
        //        } catch (final org.apache.axis2.databinding.ADBException e) {
        //            throw org.apache.axis2.AxisFault.makeFault(e);
        //        }
    }

    private org.apache.axiom.om.OMElement toOM(final br.com.codex.v1.apinfe.cte300.webservices.recepcao.CteRecepcaoStub.CteRecepcaoLoteResult param, final boolean optimizeContent) {
        //try {
        return param.getOMElement(br.com.codex.v1.apinfe.cte300.webservices.recepcao.CteRecepcaoStub.CteRecepcaoLoteResult.MY_QNAME, org.apache.axiom.om.OMAbstractFactory.getOMFactory());
        //        } catch (final org.apache.axis2.databinding.ADBException e) {
        //            throw org.apache.axis2.AxisFault.makeFault(e);
        //        }
    }

    private org.apache.axiom.om.OMElement toOM(final br.com.codex.v1.apinfe.cte300.webservices.recepcao.CteRecepcaoStub.CteCabecMsgE param, final boolean optimizeContent) {
        //try {
        return param.getOMElement(br.com.codex.v1.apinfe.cte300.webservices.recepcao.CteRecepcaoStub.CteCabecMsgE.MY_QNAME, org.apache.axiom.om.OMAbstractFactory.getOMFactory());
        //        } catch (final org.apache.axis2.databinding.ADBException e) {
        //            throw org.apache.axis2.AxisFault.makeFault(e);
        //        }
    }

    private org.apache.axiom.soap.SOAPEnvelope toEnvelope(final org.apache.axiom.soap.SOAPFactory factory, final br.com.codex.v1.apinfe.cte300.webservices.recepcao.CteRecepcaoStub.CteDadosMsg param, final boolean optimizeContent, final javax.xml.namespace.QName methodQName) {
        //try {
        final org.apache.axiom.soap.SOAPEnvelope emptyEnvelope = factory.getDefaultEnvelope();
        emptyEnvelope.getBody().addChild(param.getOMElement(br.com.codex.v1.apinfe.cte300.webservices.recepcao.CteRecepcaoStub.CteDadosMsg.MY_QNAME, factory));
    ...
    private java.lang.Object fromOM(final org.apache.axiom.om.OMElement param, final java.lang.Class type, final java.util.Map extraNamespaces) throws org.apache.axis2.AxisFault {
        try {
            if (br.com.codex.v1.apinfe.cte300.webservices.recepcao.CteRecepcaoStub.CteDadosMsg.class.equals(type)) {
                return br.com.codex.v1.apinfe.cte300.webservices.recepcao.CteRecepcaoStub.CteDadosMsg.Factory.parse(param.getXMLStreamReaderWithoutCaching());
            }
            if (br.com.codex.v1.apinfe.cte300.webservices.recepcao.CteRecepcaoStub.CteRecepcaoLoteResult.class.equals(type)) {
                return br.com.codex.v1.apinfe.cte300.webservices.recepcao.CteRecepcaoStub.CteRecepcaoLoteResult.Factory.parse(param.getXMLStreamReaderWithoutCaching());
            }
            if (br.com.codex.v1.apinfe.cte300.webservices.recepcao.CteRecepcaoStub.CteCabecMsgE.class.equals(type)) {
                return br.com.codex.v1.apinfe.cte300.webservices.recepcao.CteRecepcaoStub.CteCabecMsgE.Factory.parse(param.getXMLStreamReaderWithoutCaching());
            }

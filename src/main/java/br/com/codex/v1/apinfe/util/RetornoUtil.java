...
import br.com.codex.v1.apinfe.dom.enuns.StatusEnum;
...
public class RetornoUtil {
     ...
     * @throws NfeException
     */
    public static void validaCancelamentoSubstituicao(br.com.codex.v1.apinfe.schema.envEventoCancSubst.TRetEnvEvento retorno) throws NfeException {
        if (!StatusEnum.LOTE_EVENTO_PROCESSADO.getCodigo().equals(retorno.getCStat())) {
            throw new NfeException(retorno.getCStat() + " - " + retorno.getXMotivo());
        }
     ...
     * @throws NfeException
     */
    public static void validaManifestacao(br.com.codex.v1.apinfe.schema.envConfRecebto.TRetEnvEvento retorno) throws NfeException {
        if (!StatusEnum.LOTE_EVENTO_PROCESSADO.getCodigo().equals(retorno.getCStat())) {
            throw new NfeException(retorno.getCStat() + " - " + retorno.getXMotivo());
        }
     ...
     * @throws NfeException
     */
    public static void validaCartaCorrecao(br.com.codex.v1.apinfe.schema.envcce.TRetEnvEvento retorno) throws NfeException {
        if (!StatusEnum.LOTE_EVENTO_PROCESSADO.getCodigo().equals(retorno.getCStat())) {
            throw new NfeException(retorno.getCStat() + " - " + retorno.getXMotivo());
        }
        final String[] erro = {""};
     ...
     * @throws NfeException
     */
    public static void validaEpec(br.com.codex.v1.apinfe.schema.envEpec.TRetEnvEvento retorno) throws NfeException {
        if (!StatusEnum.LOTE_EVENTO_PROCESSADO.getCodigo().equals(retorno.getCStat())) {
            throw new NfeException(retorno.getCStat() + " - " + retorno.getXMotivo());
     ...
     * @throws NfeException
     */
    public static void validaConsultaCadastro(br.com.codex.v1.apinfe.schema.retConsCad.TRetConsCad retorno) throws NfeException {
     ...
     * @throws NfeException
     */
    public static void validaInutilizacao(br.com.codex.v1.apinfe.schema_4.inutNFe.TRetInutNFe retorno) throws NfeException {

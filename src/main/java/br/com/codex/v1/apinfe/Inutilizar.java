...
import br.com.codex.v1.apinfe.wsdl.NFeInutilizacao.NFeInutilizacao4Stub;
    ...
    static TRetInutNFe inutiliza(ConfiguracoesNfe config, TInutNFe inutNFe, DocumentoEnum tipoDocumento, boolean validar)
        ...
        try {
            ...
            if (EstadosEnum.CE.equals(config.getEstado()) ) {
                br.com.codex.v1.apinfe.wsdl.NFeInutilizacao.ce.NFeInutilizacao4Stub.NfeDadosMsg dadosMsgCe =
                        new  br.com.codex.v1.apinfe.wsdl.NFeInutilizacao.ce.NFeInutilizacao4Stub.NfeDadosMsg();
                dadosMsgCe.setExtraElement(ome);
                br.com.codex.v1.apinfe.wsdl.NFeInutilizacao.ce.NFeInutilizacao4Stub stubCe = new br.com.codex.v1.apinfe.wsdl.NFeInutilizacao.ce.NFeInutilizacao4Stub(
                        url);
                ...
                br.com.codex.v1.apinfe.wsdl.NFeInutilizacao.ce.NFeInutilizacao4Stub.NfeResultMsg resultCe = stubCe.nfeInutilizacaoNF(dadosMsgCe);

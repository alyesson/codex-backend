...
import br.com.codex.v1.apinfe.dom.enuns.EstadosEnum;
import br.com.codex.v1.apinfe.dom.enuns.PessoaEnum;
...
import br.com.codex.v1.apinfe.schema.consCad.TUfCons;
import br.com.codex.v1.apinfe.schema.retConsCad.TRetConsCad;
import br.com.codex.v1.apinfe.util.*;
import br.com.codex.v1.apinfe.wsdl.CadConsultaCadastro.CadConsultaCadastro4Stub;
    ...
    static TRetConsCad consultaCadastro(ConfiguracoesNfe config, PessoaEnum tipoPessoa, String cnpjCpf, EstadosEnum estado)
        ...
        try {
            ...
            if (EstadosEnum.MS.equals(estado)) {
                br.com.codex.v1.apinfe.wsdl.CadConsultaCadastro.ms.CadConsultaCadastro4Stub.NfeDadosMsg dadosMsg =
                        new br.com.codex.v1.apinfe.wsdl.CadConsultaCadastro.ms.CadConsultaCadastro4Stub.NfeDadosMsg();
                dadosMsg.setExtraElement(ome);

                br.com.codex.v1.apinfe.wsdl.CadConsultaCadastro.ms.CadConsultaCadastro4Stub stub =
                        new br.com.codex.v1.apinfe.wsdl.CadConsultaCadastro.ms.CadConsultaCadastro4Stub(url);
                ...
                br.com.codex.v1.apinfe.wsdl.CadConsultaCadastro.ms.CadConsultaCadastro4Stub.NfeResultMsg result = stub.consultaCadastro(dadosMsg);
                ...
                br.com.codex.v1.apinfe.wsdl.CadConsultaCadastro.rs.CadConsultaCadastro4Stub.ConsultaCadastro consultaCadastro =
                        new br.com.codex.v1.apinfe.wsdl.CadConsultaCadastro.rs.CadConsultaCadastro4Stub.ConsultaCadastro();
                br.com.codex.v1.apinfe.wsdl.CadConsultaCadastro.rs.CadConsultaCadastro4Stub.NfeDadosMsg_type0 dadosMsg = new br.com.codex.v1.apinfe.wsdl.CadConsultaCadastro.rs.CadConsultaCadastro4Stub.NfeDadosMsg_type0();
                dadosMsg.setExtraElement(ome);
                consultaCadastro.setNfeDadosMsg(dadosMsg);

                br.com.codex.v1.apinfe.wsdl.CadConsultaCadastro.rs.CadConsultaCadastro4Stub stub =
                        new br.com.codex.v1.apinfe.wsdl.CadConsultaCadastro.rs.CadConsultaCadastro4Stub(url);
                ...
                br.com.codex.v1.apinfe.wsdl.CadConsultaCadastro.rs.CadConsultaCadastro4Stub.NfeResultMsg result = stub.consultaCadastro(consultaCadastro);

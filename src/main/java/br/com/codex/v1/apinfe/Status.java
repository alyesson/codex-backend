...
import br.com.codex.v1.apinfe.util.ConstantesUtil;
...
import br.com.codex.v1.apinfe.wsdl.NFeStatusServico4.NFeStatusServico4Stub;
    ...
    static TRetConsStatServ statusServico(ConfiguracoesNfe config, DocumentoEnum tipoDocumento) throws NfeException {
        ...
        try {
            ...
            if (EstadosEnum.MS.equals(config.getEstado())) {
                br.com.codex.v1.apinfe.wsdl.NFeStatusServico4MS.NFeStatusServico4Stub.NfeDadosMsg dadosMsg =
                        new br.com.codex.v1.apinfe.wsdl.NFeStatusServico4MS.NFeStatusServico4Stub.NfeDadosMsg();
                dadosMsg.setExtraElement(ome);

                br.com.codex.v1.apinfe.wsdl.NFeStatusServico4MS.NFeStatusServico4Stub stub =
                        new br.com.codex.v1.apinfe.wsdl.NFeStatusServico4MS.NFeStatusServico4Stub(url);
                StubUtil.configuraHttpClient(stub, config, url);

                br.com.codex.v1.apinfe.wsdl.NFeStatusServico4MS.NFeStatusServico4Stub.NfeResultMsg result = stub.nfeStatusServicoNF(dadosMsg);

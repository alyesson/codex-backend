...
public class CalculoDaFolhaDescontos {
    ...
    //Faixas de cálculo do INSS, os valores abaixo são refrentes ao salário mínimo e precisam ser alterados todu ano.
    ...
    BigDecimal salaryBase = new BigDecimal();
    BigDecimal valorSalarHora = new BigDecimal();

...
import br.com.codex.v1.domain.fiscal.spedefd.geraBlocos.Bloco0;
import br.com.codex.v1.domain.fiscal.spedefd.geraBlocos.GeradorEfdIcms;
...
public class SpedEfdResource {
    ...
    public ResponseEntity<String> gerarEfdIcms(
            @RequestBody GerarSpedRequestDto requestDto // DTO com dados do front-end
    ) {
        ...
        GeradorEfdIcms.geraBlocos(bloco0, caminhoArquivo);

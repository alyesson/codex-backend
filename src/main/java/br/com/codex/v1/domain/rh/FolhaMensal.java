...
public class FolhaMensal implements Serializable {
    ...
    @Column(precision = 10, scale = 2)
    private BigDecimal horasExtras75;
    ...
    public FolhaMensal(Long id, String matriculaColaborador, String nomeColaborador, LocalDate dataAdmissao,
                       ...
                       String centroDeCusto, String contaDigito, BigDecimal horasExtras75, BigDecimal horasExtras100,
        ...
        this.horasExtras75 = horasExtras75;
    ...
    public FolhaMensal(FolhaMensalDto obj) {
        ...
        this.horasExtras75 = obj.getHorasExtras75();

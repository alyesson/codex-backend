...
public class GerarBloco0 {
    ...
    public static StringBuilder gerar(EfdIcms efdIcms, StringBuilder sbr) {
        ...
        if (!Util.isEmpty(bloco0.getRegistro0210())) {
            bloco0.getRegistro0210().forEach(registro0210 -> {
        ...
        if (!Util.isEmpty(bloco0.getRegistro0220())) {
            bloco0.getRegistro0220().forEach(registro0220 -> {
        ...
        // REGISTRO0221
        if (!Util.isEmpty(bloco0.getRegistro0221())) {
            bloco0.getRegistro0221().forEach(registro0221 -> {
                GerarRegistro0221.gerar(registro0221, sb);

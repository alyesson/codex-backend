...
public class HistoricoRemocaoContaReceberDto implements Serializable {
    @Serial
    ...
    public HistoricoRemocaoContaReceberDto() {
        super();
    }

    public HistoricoRemocaoContaReceberDto(HistoricoRemocaoContaReceber obj) {
        this.id = obj.getId();

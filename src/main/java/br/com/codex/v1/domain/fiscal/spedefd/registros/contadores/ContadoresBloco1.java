...
import br.com.codex.v1.domain.fiscal.spedefd.registros.bloco1.Bloco1Enum;
...
public class ContadoresBloco1 {
    ...
    public void incrementar(Bloco1Enum bloco) {
        ...
        switch (bloco) {
            case Registro1001 -> contRegistro1001++;
            case Registro1010 -> contRegistro1010++;
            case Registro1100 -> contRegistro1100++;
            case Registro1105 -> contRegistro1105++;
            case Registro1110 -> contRegistro1110++;
            case Registro1200 -> contRegistro1200++;
            case Registro1210 -> contRegistro1210++;
            case Registro1250 -> contRegistro1250++;
            case Registro1255 -> contRegistro1255++;
            case Registro1300 -> contRegistro1300++;
            case Registro1310 -> contRegistro1310++;
            case Registro1320 -> contRegistro1320++;
            case Registro1350 -> contRegistro1350++;
            case Registro1360 -> contRegistro1360++;
            case Registro1370 -> contRegistro1370++;
            case Registro1390 -> contRegistro1390++;
            case Registro1391 -> contRegistro1391++;
            case Registro1400 -> contRegistro1400++;
            case Registro1500 -> contRegistro1500++;
            case Registro1510 -> contRegistro1510++;
            case Registro1600 -> contRegistro1600++;
            case Registro1700 -> contRegistro1700++;
            case Registro1710 -> contRegistro1710++;
            case Registro1800 -> contRegistro1800++;
            case Registro1900 -> contRegistro1900++;
            case Registro1910 -> contRegistro1910++;
            case Registro1920 -> contRegistro1920++;
            case Registro1921 -> contRegistro1921++;
            case Registro1922 -> contRegistro1922++;
            case Registro1923 -> contRegistro1923++;
            case Registro1925 -> contRegistro1925++;
            case Registro1926 -> contRegistro1926++;
            case Registro1960 -> contRegistro1960++;
            case Registro1970 -> contRegistro1970++;
            case Registro1975 -> contRegistro1975++;
            case Registro1980 -> contRegistro1980++;
            default -> {
            }
        }
    }

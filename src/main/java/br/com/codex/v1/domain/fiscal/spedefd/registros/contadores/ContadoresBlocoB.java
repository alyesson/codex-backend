...
public class ContadoresBlocoB {
    ...
    public void incrementar(BlocoBEnum bloco) {
        ...
        switch (bloco) {
            ...
            case RegistroB001 -> contRegistroB001++;
            case RegistroB020 -> contRegistroB020++;
            case RegistroB025 -> contRegistroB025++;
            case RegistroB030 -> contRegistroB030++;
            case RegistroB035 -> contRegistroB035++;
            case RegistroB350 -> contRegistroB350++;
            case RegistroB420 -> contRegistroB420++;
            case RegistroB440 -> contRegistroB440++;
            case RegistroB460 -> contRegistroB460++;
            case RegistroB470 -> contRegistroB470++;
            case RegistroB500 -> contRegistroB500++;
            case RegistroB510 -> contRegistroB510++;
            case RegistroB990 -> contRegistroB990++;
            default -> {
            }
        }
    }

...
@Entity
public class ImportarXmlItens implements Serializable {
    @Serial
    ...
    public ImportarXmlItens(ImportarXmlItensDto obj) {
        this.id = obj.getId();

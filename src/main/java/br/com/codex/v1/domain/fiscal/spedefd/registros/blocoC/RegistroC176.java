...
package br.com.codex.v1.domain.fiscal.spedefd.registros.blocoC;
...
public class RegistroC176 {
    ...
    /**
     * @param chave_nfe_ult_e the chave_nfe_ult_e to set
     */
    public void setChave_nfe_ult_e(String chave_nfe_ult_e) {
        this.chave_nfe_ult_e = chave_nfe_ult_e;
    }

    /**
     * @return the num_item_ult_e
     */
    ...
    /**
     * @param num_item_ult_e the num_item_ult_e to set
     */
    public void setNum_item_ult_e(String num_item_ult_e) {
        this.num_item_ult_e = num_item_ult_e;
    }

    /**
     * @return the vl_unit_bc_icms_ult_e
     */
    ...
    /**
     * @param vl_unit_bc_icms_ult_e the vl_unit_bc_icms_ult_e to set
     */
    public void setVl_unit_bc_icms_ult_e(String vl_unit_bc_icms_ult_e) {
        this.vl_unit_bc_icms_ult_e = vl_unit_bc_icms_ult_e;
    }

    /**
     * @return the aliq_icms_ult_e
     */
    ...
    /**
     * @param aliq_icms_ult_e the aliq_icms_ult_e to set
     */
    public void setAliq_icms_ult_e(String aliq_icms_ult_e) {
        this.aliq_icms_ult_e = aliq_icms_ult_e;
    }

    /**
     * @return the vl_unit_limite_bc_icms_ult_e
     */
    ...
    /**
     * @param vl_unit_limite_bc_icms_ult_e the vl_unit_limite_bc_icms_ult_e to
     *                                     set
     */
    public void setVl_unit_limite_bc_icms_ult_e(String vl_unit_limite_bc_icms_ult_e) {
        this.vl_unit_limite_bc_icms_ult_e = vl_unit_limite_bc_icms_ult_e;
    }

    /**
     * @return the vl_unit_icms_ult_e
     */
    ...
    /**
     * @param vl_unit_icms_ult_e the vl_unit_icms_ult_e to set
     */
    public void setVl_unit_icms_ult_e(String vl_unit_icms_ult_e) {
        this.vl_unit_icms_ult_e = vl_unit_icms_ult_e;
    }

    /**
     * @return the aliq_st_ult_e
     */
    ...
    /**
     * @param aliq_st_ult_e the aliq_st_ult_e to set
     */
    public void setAliq_st_ult_e(String aliq_st_ult_e) {
        this.aliq_st_ult_e = aliq_st_ult_e;
    }

    /**
     * @return the vl_unit_res
     */
    ...
    /**
     * @param vl_unit_res the vl_unit_res to set
     */
    public void setVl_unit_res(String vl_unit_res) {
        this.vl_unit_res = vl_unit_res;
    }

    /**
     * @return the cod_resp_ret
     */
    ...
    /**
     * @param cod_resp_ret the cod_resp_ret to set
     */
    ...
    /**
     * @param cod_mot_res the cod_mot_res to set
     */
    public void setCod_mot_res(String cod_mot_res) {
        this.cod_mot_res = cod_mot_res;
    }

    /**
     * @return the chave_nfe_ret
     */
    ...
    /**
     * @param chave_nfe_ret the chave_nfe_ret to set
     */
    public void setChave_nfe_ret(String chave_nfe_ret) {
        this.chave_nfe_ret = chave_nfe_ret;
    }

    /**
     * @return the cod_part_nfe_ret
     */
    ...
    /**
     * @param cod_part_nfe_ret the cod_part_nfe_ret to set
     */
    public void setCod_part_nfe_ret(String cod_part_nfe_ret) {
        this.cod_part_nfe_ret = cod_part_nfe_ret;
    }

    /**
     * @return the ser_nfe_ret
     */
    ...
    /**
     * @param ser_nfe_ret the ser_nfe_ret to set
     */
    public void setSer_nfe_ret(String ser_nfe_ret) {
        this.ser_nfe_ret = ser_nfe_ret;
    }

    /**
     * @return the num_nfe_ret
     */
    ...
    /**
     * @param num_nfe_ret the num_nfe_ret to set
     */
    public void setNum_nfe_ret(String num_nfe_ret) {
        this.num_nfe_ret = num_nfe_ret;
    }

    /**
     * @return the item_nfe_ret
     */
    ...
    /**
     * @param item_nfe_ret the item_nfe_ret to set
     */
    public void setItem_nfe_ret(String item_nfe_ret) {
        this.item_nfe_ret = item_nfe_ret;
    }
    ...
    /**
     * @return the vl_unit_res_fcp_st
     */
    public String getVl_unit_res_fcp_st() {
        return vl_unit_res_fcp_st;
    }

    /**
     * @param vl_unit_res_fcp_st the vl_unit_res_fcp_st to set
     */
    public void setVl_unit_res_fcp_st(String vl_unit_res_fcp_st) {
        this.vl_unit_res_fcp_st = vl_unit_res_fcp_st;
    }
